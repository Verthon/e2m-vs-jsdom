...
export const specialtiesResponseMock = [
  {
    icon: `<svg width="24" height="24" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    id: "1",
    isActive: true,
    name: { en: "General Practitioner" },
    description: { en: "Primary care, wellness exams, and general health concerns" },
  },
  {
    icon: `<svg width="24" height="24" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    isActive: true,
    name: { en: "Psychiatry" },
    description: { en: "Mental health services, therapy coordination, and medication management" },
  },
  {
    icon: `<svg width="24" height="24" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
